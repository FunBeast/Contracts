...
// File: contracts/BeastPoolInitializable.sol

pragma solidity 0.6.12;

contract BeastPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public BEAST_POOL_FACTORY;
    ...
    function initialize(
        ...
        require(msg.sender == BEAST_POOL_FACTORY, "Not factory");
...
// File: contracts/BeastPoolFactory.sol

pragma solidity 0.6.12;

contract BeastPoolFactory is Ownable {
    event NewBeastPoolContract(address indexed smartChef);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(BeastPoolInitializable).creationCode;
        bytes32 salt =
            keccak256(
        ...
        BeastPoolInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewBeastPoolContract(smartChefAddress);
    }
}
